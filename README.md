...
- **[AnyGas](https://github.com/ox31461/Gasless-Anygas-ROBYN-Relay)** - Gasless cross-chain intent relay for AI agents: sign one intent in the token you hold, a relayer fronts native gas on every leg across 25 nodes (22 EVM + Stellar + Solana + native Bitcoin).
